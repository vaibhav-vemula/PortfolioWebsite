...
const Carddata = [
  ...
  },
  {
    ...
    subtitle: "Given a CCTV footage of a secure door entry, detecting if anyone is tailgating or not using computer vision and deep learning.",
  ...
  
  {
    ...
    subtitle: "Project (written in C) to convert C language code to its equivalent Python code",
 ...
 
  {
    ...
    subtitle: "Classification of various biodegradable and non biodegradable waste using CNN.",
